...
BoundingBox.prototype.newBoundingBox = function(x_1, y_1, x_2, y_2) {
  this.x1= x_1;
  this.y1= y_1;
  this.x2= x_2;
  this.y2= y_2;
...
Font.prototype.getPathLetter = function(text, x, y, fontSize, options) {
  var fullPath = new Array();
  var count_g=0;
  var BoundingBox_prev;
  var Bx=0;
  var By=0;
  this.forEachGlyph(text, x, y, fontSize, options, function(glyph, gX, gY, gFontSize) {
    fullPath[count_g] = new path.Path();
    var glyphPath = glyph.getPath(0, gY, gFontSize);
    fullPath[count_g]=(glyphPath);
        //fullPath[count_g].extend(glyphPath);
        count_g++;
      });
...
Font.prototype.checkWords = function(text, x, y, fontSize, options) {
  var fullPath = new path.Path();
  var max_size= 0;
  var margin=10;
  this.forEachGlyph(text, x, y, fontSize, options, function(glyph, gX, gY, gFontSize) {
    var metrics= glyph.getMetrics();
        //var glyphPath = glyph.getPath(gX, gY, gFontSize);
          var glyphPath = glyph.getPath_checkMetrics(gX, gY, gFontSize,metrics);
        
        max_size+=glyphPath;
        //console.log("letra: "+glyphPath+" name: "+glyph.name);
...
Font.prototype.checkWordsLetter = function(text, x, y, fontSize, options) {
...
Glyph.prototype.getPath_checkMetrics = function(x, y, fontSize, options, metrics) {
  x = x !== undefined ? x : 0;
  y = y !== undefined ? y : 0;
  metrics = metrics !== undefined ? metrics : this.getMetrics();
  options = options !== undefined ? options : {xScale: 1.0, yScale: 1.0};
  fontSize = fontSize !== undefined ? fontSize : 72;
  ...
  if (this.name!="space"){
    ...
    var sum = this.advanceWidth;
    var total = (sum*scale);
  }else{
    var scale = 1/ 1000 * fontSize;
     var total =this.advanceWidth*scale;
 }
